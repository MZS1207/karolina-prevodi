...
const translations = {
    en: {
        ...
        'testimonial-1-name': 'Dr. Sarah Johnson',
        'testimonial-1-title': 'Medical Director, PharmaCorp',
        ...
        'testimonial-2-name': 'Mark Novak',
        'testimonial-2-title': 'Publisher, Balkan Books',
        ...
        'testimonial-3-name': 'Engineer Milan PetroviÄ',
        'testimonial-3-title': 'Technical Manager, IndusTech',
    ...
    sr: {
        ...
        // Hero Section
        'hero-title': 'Srpsko-Engleski <span class="highlight">Ekspert za PrevoÄenje</span>',
        'hero-subtitle': 'Specijalizovane prevodilaÄke usluge za knjige, medicinske dokumente i tehniÄke materijale sa kulturnom preciznoÅ¡Äu.',
        'btn-get-quote': 'ZatraÅ¾ite Ponudu',
        'btn-view-work': 'Pogledajte Rad',
        
        // Services Section
        'services-badge': 'Å to radimo',
        'services-title': 'NaÅ¡e Usluge',
        'services-subtitle': 'Specijalizovane prevodilaÄke usluge srpski-engleski',
        'service-books-title': 'PrevoÄenje Knjiga',
        'service-books-desc': 'Profesionalno prevoÄenje beletristike i non-fiction knjiga, sa Äuvanjem autorovog glasa i kulturnih nijansi izmeÄu srpskog i engleskog.',
        'service-medical-title': 'Medicinsko i Farmaceutsko',
        'service-medical-desc': 'Specijalizovano prevoÄenje medicinskih dokumenata, farmaceutskih materijala, informacija za pacijente i kliniÄkih istraÅ¾ivanja sa preciznom medicinskom terminologijom.',
        'service-technical-title': 'TehniÄki PriruÄnici',
        ...
        'about-description': 'Profesionalni prevodilac sa godinama iskustva u premoÅ¡avanju komunikacijskih jazova izmeÄu jezika i kultura. Moja strast prema jezicima i paÅ¾nja prema detaljima osiguravaju da svaki prevod zadrÅ¾i originalno znaÄenje, ton i kulturne nijanse.',
        'stat-projects-number': '500+',
        'stat-projects-label': 'ZavrÅ¡enih Projekata',
        'stat-langs-number': '15+',
        'stat-langs-label': 'Jezickih Parova',
        'stat-satisfaction-number': '98%',
        'stat-satisfaction-label': 'Zadovoljstva Klijenata',
        'skills-title': 'JeziÄko Znanje',
        'skill-english': 'Engleski',
        'skill-german': 'NemaÄki',
        'skill-spanish': 'Å panski',
        'skill-french': 'Francuski',
        
        // Service Features
        'feature-literary': 'KnjiÅ¾evna Izvrsnost',
        'feature-cultural': 'Kulturna AutentiÄnost',
        'feature-medical-accuracy': 'Medicinska Preciznost',
        'feature-regulatory': 'Regulatorna UsklaÄenost',
        'feature-technical': 'TehniÄko Znanje',
        ...
        'portfolio-book-title': 'PrevoÄenje Beleristike',
        'portfolio-book-desc': 'Kompletno prevoÄenje savremene srpske beletristike na engleski, sa Äuvanjem knjiÅ¾evnog stila i kulturnog konteksta za meÄunarodnu publiku.',
        'portfolio-pharma-title': 'Farmaceutska Dokumentacija',
        'portfolio-pharma-desc': 'PrevoÄenje informacija o proizvodima, dokumentacije kliniÄkih ispitivanja i materijala za usklaÄenje sa regulatorima za meÄunarodne farmaceutske kompanije.',
        'portfolio-technical-title': 'PrevoÄenje TehniÄkih PriruÄnika',
        'portfolio-technical-desc': 'TehniÄko prevoÄenje korisniÄkih priruÄnika za industrijske maÅ¡ine i sigurnosnih uputstava sa engleskog na srpski za implementaciju u proizvodnim objektima.',
        
        // Tags
        'tag-literary': 'KnjiÅ¾evno',
        'tag-sr-en': 'Srpski-Engleski',
        'tag-fiction': 'Beleristika',
        'tag-pharmaceutical': 'Farmaceutsko',
        'tag-en-sr': 'Engleski-Srpski',
        'tag-regulatory': 'Regulatorno',
        'tag-technical': 'TehniÄko',
        'tag-manuals': 'PriruÄnici',
        
        // Contact Section
        'contact-title': 'Kontaktirajte Nas',
        'contact-description': 'Spremni da sruÅ¡ite jeziÄke barijere? Kontaktirajte me za besplatnu konsultaciju i ponudu za vaÅ¡e prevodilaÄke potrebe.',
        'contact-email-label': 'Email',
        ...
        // Footer
        'footer-description': 'Profesionalne prevodilaÄke usluge srpski-engleski koje povezuju jezike i kulture Å¡irom sveta.',
        ...
        'footer-copyright': '&copy; 2024 Karolina Prevodi. Sva prava zadrÅ¾ana.',
        
        // Testimonials Section
        'testimonials-badge': 'Reference Klijenata',
        'testimonials-title': 'Å to Klijenti KaÅ¾u',
        'testimonials-subtitle': 'Stvarni utisci od zadovoljnih klijenata',
        'testimonial-1-text': 'Karolinin prevod naÅ¡e medicinske dokumentacije bio je izvanredan. Njena paÅ¾nja prema detaljima i razumevanje sloÅ¾ene terminologije uÅ¡tedela nam je nedeljama rada.',
        'testimonial-1-name': 'Dr. Sara JovanoviÄ',
        'testimonial-1-title': 'Medicinski Direktor, PharmaCorp',
        'testimonial-2-text': 'KnjiÅ¾evni prevod koji nam je Karolina pruÅ¾ila za roman bio je prelep. Uhvatila je suÅ¡tinu i kulturne nijanse savrÅ¡eno.',
        'testimonial-2-name': 'Mark Novak',
        'testimonial-2-title': 'IzdavaÄ, Balkan Books',
        'testimonial-3-text': 'TehniÄki priruÄnici prevedeni sa preciznoÅ¡Äu i taÄnoÅ¡Äu. Karolina razume inÅ¾enjersku terminologiju i isporuÄuje na vreme.',
        'testimonial-3-name': 'InÅ¾enjer Milan PetroviÄ',
        'testimonial-3-title': 'TehniÄki MenadÅ¾er, IndusTech',
        
        // Process Section
        'process-badge': 'Kako FunkioniÅ¡e',
        'process-title': 'Proces PrevoÄenja',
        'process-subtitle': 'Jednostavan i efikasan radni tok',
        'step-1-title': 'Konsultacija',
        'step-1-desc': 'Razgovaramo o zahtevima vaÅ¡eg projekta, roku i specifiÄnim potrebama da bismo osigurali savrÅ¡eno razumevanje.',
        ...
        'step-3-title': 'PrevoÄenje',
        'step-3-desc': 'Profesionalno prevoÄenje sa paÅ¾njom na kulturni kontekst, terminologiju i doslednost stila.',
        'step-4-title': 'Provera i Isporuka',
        'step-4-desc': 'Provera kvaliteta i pravovremena isporuka vaÅ¡ih prevedenih dokumenata u Å¾eljenom formatu.',
        
        // FAQ Section
        'faq-badge': 'Äesto Postavljena Pitanja',
        'faq-title': 'UobiÄajena Pitanja',
        'faq-subtitle': 'Sve Å¡to trebate da znate o naÅ¡im uslugama',
        'faq-1-question': 'IzmeÄu kojih jezika prevodite?',
        'faq-1-answer': 'Specijalizujem se za srpsko-engleske i englesko-srpske prevode. Ova fokusirana ekspertiza mi omoguÄava da pruÅ¾im prevode najviÅ¡eg kvaliteta sa dubokim kulturnim razumevanjem i preciznom terminologijom.',
        'faq-2-question': 'Koliko traje tipiÄan prevod?',
        'faq-2-answer': 'Vreme isporuke zavisi od duÅ¾ine i sloÅ¾enosti dokumenta. TipiÄno, 1-5 stranica traje 2-3 dana, dok veÄi projekti mogu zahtevati 1-2 nedelje. Uvek pruÅ¾am jasne rokove u naÅ¡oj poÄetnoj konsultaciji.',
        'faq-3-question': 'Da li pruÅ¾ate sertifikovane prevode?',
        'faq-3-answer': 'Da, pruÅ¾am sertifikovane prevode za pravne dokumente, imigraciona papire i zvaniÄne svrhe. Svi sertifikovani prevodi ukljuÄuju izjavu o taÄnosti i moje profesionalne kredencijale.',
        'faq-4-question': 'U kojim industrijama se specijalizujete?',
        'faq-4-answer': 'Moje glavne specijalizacije ukljuÄuju knjiÅ¾evna dela (beletristika i non-fiction), medicinske i farmaceutske dokumente, tehniÄke priruÄnike i opÅ¡te poslovne dokumente. Imam ekstenzivno iskustvo u svakoj od ovih oblasti.',
        'faq-5-question': 'Kako osiguravate kvalitet prevoda?',
        'faq-5-answer': 'Pratim strogi proces kvaliteta ukljuÄujuÄi istraÅ¾ivanje terminologije, kulturnu adaptaciju, viÅ¡e faza provere i ukljuÄivanje povratnih informacija klijenata. Svaki prevod je proveren za taÄnost i doslednost stila.',
        
        // CTA Section
        'cta-title': 'Spremni da SruÅ¡ite JeziÄke Barijere?',
        'cta-subtitle': 'NaruÄite vaÅ¡ profesionalni srpsko-engleski prevod danas. Brz, taÄan i kulturno svestan.',
        'cta-get-started': 'ZapoÄnite',
        'cta-learn-more': 'Saznajte ViÅ¡e',
