...
const translations = {
    en: {
        ...
        'testimonial-1-text': 'Karolina\'s translation of our medical documentation was exceptional. Her attention to detail and understanding of complex terminology saved us weeks of work. Everything handled under strict NDA protection.',
        'testimonial-1-name': 'Client A',
        'testimonial-1-title': 'Leading Medical Director',
        'testimonial-2-text': 'The literary translation Karolina provided for our novel was beautiful. She captured the essence and cultural nuances perfectly. Discretion and professionalism are at the highest level.',
        'testimonial-2-name': 'Client B',
        'testimonial-2-title': 'Publishing Director',
        'testimonial-3-text': 'Technical manuals translated with precision and accuracy. Karolina understands engineering terminology and delivers on time. Data protection is always a priority.',
        'testimonial-3-name': 'Client C',
        'testimonial-3-title': 'Technical Director',
    ...
    sr: {
        ...
        'testimonial-1-text': 'Karolinin prevod na\u0161e medicinske dokumentacije bio je izvanredan. Njena pa\u017enja prema detaljima i razumevanje slo\u017eene terminologije u\u0161tedela nam je nedeljama rada. Sve je ura\u0111eno pod strogoj NDA za\u0161titom.',
        'testimonial-1-name': 'Klijent A',
        'testimonial-1-title': 'Vode\u0107i Medicinski Direktor',
        'testimonial-2-text': 'Knji\u017eevni prevod koji nam je Karolina pru\u017eila za roman bio je prelep. Uhvatila je su\u0161tinu i kulturne nijanse savr\u0161eno. Diskrecija i profesionalnost su na najvi\u0161em nivou.',
        'testimonial-2-name': 'Klijent B',
        'testimonial-2-title': 'Izdava\u010dki Direktor',
        'testimonial-3-text': 'Tehni\u010dki priru\u010dnici prevedeni sa precizno\u0161\u0107u i ta\u010dno\u0161\u0107u. Karolina razume in\u017eenjersku terminologiju i isporu\u010duje na vreme. Za\u0161titu podataka je uvek prioritet.',
        'testimonial-3-name': 'Klijent C',
        'testimonial-3-title': 'Tehni\u010dki Direktor',
