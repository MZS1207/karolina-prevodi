...
The supplied historical CV is the source for employment dates, the Mediante role, bachelor’s degree dates, published translations and French proficiency. Current public-facing CVs retain the approved portrait and matching bilingual layout. The historical source document is not published.
