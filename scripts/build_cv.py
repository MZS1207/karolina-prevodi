...
left.p(tr('Monograph / into English / 2021','Monografija / na engleski / 2021'),size=8,leading=11.5,color=MUTED,after=10)
left.p('<b>Bitka kod Sente: slika slavne istorije</b>',size=8.5,leading=12,after=4)
left.p(tr('Book / into English / 2019','Knjiga / na engleski / 2019'),size=8,leading=11.5,color=MUTED,after=0)
